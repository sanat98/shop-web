...
function CustomerDetail() {
    const [name, setName] = useState("sanat");
    const [last, setLast] = useState("kumar");
    const [dob, setDob] = useState("01/02/07");
    const [mob, setMob] = useState(7677456878);
    const [address, setAddress] = useState('gardanibagh damaria');
    //const [panNum, setPanNum] = useState();
    const [aadharNum, setAadharNum] = useState('1111,2222,3333');
    ...
    const[togelPay,setTogelPay]=useState("");
    const[togelTitle,setTogelTitle]=useState("CUSTOMER DETAIL");
     ...
     const editable = () => {
        if (togelReadonly === "readonly") {
            ...
            setTogelColor("#f67");
            setTogelSubmit("");
            setTogelTitle("EDIT CUSTOMER DETAIL");
            setTogelPay("none");
        }
        if (togelReadonly !== "readonly") {
    ...
    return (
        <div>
            ...
            <Card style={{ width: '100%', height: "50%", }}>
                ...
                <Card.Body>
                    <Card.Title ><div style={{ marginBottom: "-21px", zIndex: "1", display: "flex" }} className=""><div style={{ marginBottom: "-8px", zIndex: "1", backgroundColor: "white" }}><b>{togelTitle}</b></div></div></Card.Title>
...
<div className="col-md-7 mt-4 mb-4" >
    <div style={{ marginBottom: "-15px", zIndex: "1", display: "flex" }} className="">
        <div style={{ backgroundColor: "white", borderRadius: "5px", boxShadow: "0px -5px 10px 0px inset"+togelColor }}>
            <h3 style={{ marginBottom: "-2px" }}>CUSTOMER DETAIL</h3></div>
    </div>
    ...
    <div className="row" style={{ border: "1px solid"+togelColor, borderRadius: "5px", padding: "20px 0 10px 2px", boxShadow: "5px 10px 20px 2px inset"+togelColor }}>
                                        ...
                                        <Form.Group className="col-md-12 mt-3" controlId="" style={{ marginBottom: "10px" }}>
                                            <Form.Label style={{ marginBottom: "0" }}>Address/Location<span style={{ color: "white" }}>cccc</span></Form.Label>
                                            {/* <Form.Control readOnly type="" id="" name="" value={address} onChange={(e) => setAddress(e.target.value)} /> */}
                                            <textarea readOnly={togelReadonly} className="col-md-12" value={address} onChange={(e) => setAddress(e.target.value)}  ></textarea>
                                        </Form.Group>
                                        ...
                                        {/* <FormInput
                                            ...
                                            type="text"
                                            value={address}
                                            myOnChange={(e) => setAddress(e.target.value)}
                                        /> */}
                                     ...
                                     <div className="row">
                                        ...
                                        <div className="col-md-5" style={{marginLeft:"20%"}}>Profile Picture</div></div>
                                            ...
                                            <div style={{ display: "flex", justifyItems: "center", justifyContent: "center" }}>
                                                <img  src={profileImg} width="60%" height="150px" alt="image" style={{ borderRadius: "5px" }}></img>
                                            </div>
                                    ...
                                    {/* ...aadhar... */}
                                        <div className="col-md-12 mt-2 mb-2 " style={{}}>
                                            ...
                                            <div style={{ display: "flex", justifyItems: "center", justifyContent: "center" }}>
                                                ...
                                                <img src={aadharImg} width="60%" height="150px" alt="image" style={{ borderRadius: "5px" }}></img>
                                            </div>
                                            <div className="mt-2" style={{ display: "flex", justifyItems: "center", justifyContent: "center", backgroundColor: "" }}>
                            ...
                            {/* </div> */}
                             ...
                             <div className="row" style={{backgroundColor:"",display:togelPay}}>
                                     <div className='col-md-12 ' style={{ display: "flex", justifyContent: "center",justifyItems:"center",backgroundColor:"" }}>
                                    
                                        <div className="mr-4 " style={{ alignSelf: 'center' }}>
                                    ...
                                    <div>Purchage Count:10 <br></br> Return Count:2 <br></br>Due Amount:Rs 2000 <br></br>Last Purchage:01/04/2021</div>
                                </div>
