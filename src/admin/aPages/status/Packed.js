              ...
              <table className="table table-striped  table-sm row-border hover ">
                <thead>
                  <tr>
                    ...
                    <th scope="col"><div style={{display:"flex",justifyContent:"center"}}>Status</div></th>
                    ...
                    this.state.tableData.map((data) => (
                      ...
                      <tr key={data.Id}>
                        ...
                        <td scope="row"> <div style={{display:"flex",justifyContent:"center",flexDirection:"column"}}>
                             <Badge pill variant="success" className="mr-2 mt-2 mb-2 "style={{height:"30px",paddingTop:"10px"}} > Packed </Badge>
