    ...
    return (
        <div>
            ...
            <Card style={{ width: '100%', height: "50%", }}>
                ...
                <Card.Body>
                    <Card.Title ><div style={{ marginBottom: "-21px", zIndex: "1", display: "flex" }} className=""><div style={{ marginBottom: "-8px", zIndex: "1", backgroundColor: "white" }}><b>ADD CUSTOMER</b></div></div></Card.Title>
...
<div className="col-md-7 mt-4 mb-4" >
    ...
    <div className="row" style={{ border: "1px solid #ccc", borderRadius: "5px", padding: "20px 0 10px 2px", boxShadow: "5px 10px 20px 2px #ccc inset" }}>
                                        ...
                                        <Form.Group className="col-md-12 mt-3" controlId="" style={{ marginBottom: "10px" }}>
                                            ...
                                            <textarea className="col-md-12" value={address} onChange={(e) => setAddress(e.target.value)}  ></textarea>
                                        </Form.Group>
