                ...
                <div className="col-md-12">
                    ...
                    >
                        ...
                        <AgGridReact
                            ...
                            rowData={rowData}
                        >
                            <AgGridColumn headerName="date" field="date" sortable={true} filter={true} minWidth={"50"} cellStyle={dynamicCellStyle} ></AgGridColumn>
                            ...
                            <AgGridColumn headerName="advance payment" field="advance" sortable={true} filter={true} minWidth={"50"} cellStyle={dynamicCellStyle}></AgGridColumn>
                            <AgGridColumn headerName="balance ammount" field="balance" sortable={true} filter={true} minWidth={"50"} cellStyle={dynamicCellStyle}></AgGridColumn>
